...
class CI_DB_oci8_driver extends CI_DB
{
    ...
    {
        return @oci_connect($this->username, $this->password, $this->hostname, 
                $this->char_set);
    }
    ...
    {
        return @oci_pconnect($this->username, $this->password, $this->hostname, 
                $this->char_set);
    }
    ...
    public function stored_procedure ($package, $procedure, $params)
    {
        if ($package == '' or $procedure == '' or ! is_array($params)) {
            if ($this->db_debug) {
                log_message('error', 'Invalid query: ' . $package . '.' .
                         $procedure);
     ...
     * @return string
     */
    protected function _update ($table, $values, $where, $orderby = array(), 
            $limit = FALSE)
    {
