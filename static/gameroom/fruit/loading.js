(function() {
    ...
    var createDom = function(id, num) {
        ...
        span.innerHTML = "<font  style=' font-size: 10px;color:#C90D17;' >正在加载游戏引擎...</font>";
      //  div.appendChild(bar);
