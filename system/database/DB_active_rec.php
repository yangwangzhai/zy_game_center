...
class CI_DB_active_record extends CI_DB_driver
{
    ...
    public function join ($table, $cond, $type = '')
    {
        ...
        $join = $type . 'JOIN ' .
                 $this->_protect_identifiers($table, TRUE, NULL, FALSE) . ' ON ' .
                 $cond;
    ...
    public function set ($key, $value = '', $escape = TRUE)
    {
        ...
        foreach ($key as $k => $v) {
            if ($escape === FALSE) {
                ...
                $this->ar_set[$this->_protect_identifiers($k, FALSE, TRUE)] = $this->escape(
                        $v);
            }
        }
    ...
    public function insert_batch ($table = '', $set = NULL)
    {
        ...
        for ($i = 0, $total = count($this->ar_set); $i < $total; $i = $i + 100) {
            ...
            $sql = $this->_insert_batch(
                    ...
                    $this->ar_keys, array_slice($this->ar_set, $i, 100));
    ...
    public function update ($table = '', $set = NULL, $where = NULL, $limit = NULL)
    {
        ...
        $sql = $this->_update(
                $this->_protect_identifiers($table, TRUE, NULL, FALSE), 
                $this->ar_set, $this->ar_where, $this->ar_orderby, 
                $this->ar_limit);
    ...
    public function update_batch ($table = '', $set = NULL, $index = NULL)
    {
        ...
        for ($i = 0, $total = count($this->ar_set); $i < $total; $i = $i + 100) {
            $sql = $this->_update_batch(
                    ...
                    $this->_protect_identifiers($index), $this->ar_where);
        ...
        foreach ($key as $k => $v) {
            ...
            foreach ($v as $k2 => $v2) {
                ...
                if ($escape === FALSE) {
                    ...
                    $clean[$this->_protect_identifiers($k2)] = $this->escape(
                            $v2);
                }
            }
    ...
    public function delete ($table = '', $where = '', $limit = NULL, $reset_data = TRUE)
    {
        ...
        $sql = $this->_delete($table, $this->ar_where, $this->ar_like, 
                $this->ar_limit);
