...
if (! function_exists('load_class')) {
    ...
    function &load_class ($class, $directory = 'libraries', $prefix = 'CI_')
    {
        ...
        if (file_exists(
                APPPATH . $directory . '/' . config_item('subclass_prefix') .
                         $class . '.php')) {
            $name = config_item('subclass_prefix') . $class;
            
            if (class_exists($name) === FALSE) {
                require (APPPATH . $directory . '/' .
...
if (! function_exists('get_config')) {
    ...
    function &get_config ($replace = array())
    {
        ...
        if (! defined('ENVIRONMENT') or
                 ! file_exists(
                        $file_path = APPPATH . 'config/' . ENVIRONMENT .
                         '/config.php')) {
...
if (! function_exists('show_error')) {
            ...
            $heading = 'An Error Was Encountered')
    {
        ...
        echo $_error->show_error($heading, $message, 'error_general', 
                $status_code);
        exit();
    }
}
...
if (! function_exists('set_status_header')) {
    ...
    function set_status_header ($code = 200, $text = '')
    {
        ...
        } elseif ($server_protocol == 'HTTP/1.1' or
