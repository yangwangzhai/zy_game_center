...
class log extends Content
{
    ...
    {    
        ...
        $this->control = 'log';
        $this->baseurl = 'index.php?d=craps&c=log&ActiveID='.$this->ActiveID.'&ChannelID='.$this->ChannelID.'&RoomID='.$this->RoomID;
        $this->table = 'zy_craps_log';
        $this->list_view = 'craps/log_list';
    }
