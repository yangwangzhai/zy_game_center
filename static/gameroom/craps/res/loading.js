(function() {
    ...
    var createDom = function(id, num) {
        ...
        span.innerHTML = "<span  style=' font-size: 30px;' >正在加载游戏引擎...</span>";
        //div.appendChild(bar);
    ...
    var startAnimation = function(list, callback) {
		...
		//document.body.style.background = "url('res/loading.png')  no-repeat center center";
