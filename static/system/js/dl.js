$(function() {    
    if (!window.ActiveXObject && !!document.createElement("canvas").getContext) {
        $.getScript("static/system/js/cav.js", function() {
            var t = {width: 2.5,height: 2.5,depth: 10,segments: 12,slices: 6,xRange: 0.8,yRange: 0.1,zRange: 1,ambient: "#023c5b",diffuse: "#FFFFFF",speed: 0.0002};
            var G = {count: 2,xyScalar: 1,zOffset: 100,ambient: "#015266",diffuse: "#00a3dd",speed: 0.001,gravity: 1200,dampening: 0.95,minLimit: 10,maxLimit: null,minDistance: 20,maxDistance: 400,autopilot: false,draw: false,bounds: CAV.Vector3.create(),step: CAV.Vector3.create(Math.randomInRange(0.2, 1), Math.randomInRange(0.2, 1), Math.randomInRange(0.2, 1))};
            var m = "canvas";
            var E = "svg";
            var x = {renderer: m};
            var i, n = Date.now();
