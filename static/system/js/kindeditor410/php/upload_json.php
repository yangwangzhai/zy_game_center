...
if (empty($_FILES) === false) {
	...
	//$e=mb_detect_encoding($file_name, array('UTF-8', 'GBK','gb2312'));
	...
	if( $ip == '119.29.87.142'){
		...
		$insert_sql = "INSERT INTO `zy_attachment` (`file_name`,`file_size`,`filepath`,`fromIP`, `addtime`)VALUES('{$file_name}','{$file_size}','{$new_file_url}','{$ip}',{$time})";
