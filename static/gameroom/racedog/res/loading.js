(function() {
    ...
    var createDom = function(id, num) {
        ...
        div.className = "cocosLoading rotate90";
        div.id = id;
        ...
        span.innerHTML = "<font  style=' font-size: 12px;' >正在加载游戏引擎...</font>";
        div.appendChild(bar);
    ...
    var startAnimation = function(list, callback) {
      ...
      //  document.body.style.background = "#fff";
        document.body.style.background = "url('static/gameroom/racedog/res/Normal/loading_bg.jpg')  no-repeat center";
