var HeroSprite = cc.Sprite.extend({
	...
	onEnter:function () {
		cc.log("onEnter");
		this._super();
		this.heroRunAction = this.createHeroRunActionAction();
		this.heroRunAction.retain();
	...
	onExit:function () {
		cc.log("onExit");
		this.heroRunAction.release();
		this._super();
	},

	createHeroRunActionAction : function() {
		var frames = [];
		for (var i = 1; i < 24; i++) {
			var str = "left"+((i < 10) ? ("0" + i) : i)+".png";
			//cc.log(str);
