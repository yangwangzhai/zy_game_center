...
class CI_User_agent
{
    ...
    private function _load_agent_file ()
    {
        if (defined('ENVIRONMENT') and
                 is_file(APPPATH . 'config/' . ENVIRONMENT . '/user_agents.php')) {
    ...
    public function is_browser ($key = NULL)
    {
        ...
        return array_key_exists($key, $this->browsers) and
                 $this->browser === $this->browsers[$key];
    }
    ...
    public function is_robot ($key = NULL)
    {
        ...
        return array_key_exists($key, $this->robots) and
                 $this->robot === $this->robots[$key];
    }
    ...
    public function is_mobile ($key = NULL)
    {
        ...
        // Check for a specific robot
        return array_key_exists($key, $this->mobiles) and
                 $this->mobile === $this->mobiles[$key];
    }
    ...
    {
        return (! isset($_SERVER['HTTP_REFERER']) or
                 $_SERVER['HTTP_REFERER'] == '') ? '' : trim(
