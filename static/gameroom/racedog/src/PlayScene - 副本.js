...
var PlayLayer = cc.Layer.extend({
    ...
    ctor:function () {
		...
		this.redline.setPosition(0,142);
		this.sprite.addChild(this.redline, 100);
     ...
     //   this.addChild(timebox);
      ...
      //  this.followAction = new cc.follow(this.dog2, cc.rect(0, -950, size.width, followheight ));
        ...
        //我的本场下注
        var mycurGameSum = myselfYD.dog2 + myselfYD.dog3 + myselfYD.dog4 + myselfYD.dog5;
        var mybet = new cc.LabelTTF("我的本场下注：" + mycurGameSum.toString() , "Arial", 25);
        mybet.attr({
        ...
        //我的2号狗下注
        var mybet2 = new cc.LabelTTF("2号："+ myselfYD.dog2.toString() , "Arial", 25);
        mybet2.attr({
            x:bottom_bar.width/2-2,
        ...
        //我的3号狗下注
        var mybet3 = new cc.LabelTTF("3号：" + myselfYD.dog3.toString(), "Arial", 25);
        mybet3.attr({
            x:bottom_bar.width/2-2,
        ...
        //我的4号狗下注
        var mybet4 = new cc.LabelTTF("4号：" + myselfYD.dog4.toString(), "Arial", 25);
        mybet4.attr({
            x:bottom_bar.width/2-2,
        ...
        //我的5号狗下注
        var mybet5 = new cc.LabelTTF("5号："+ myselfYD.dog5.toString() , "Arial", 25);
        mybet5.attr({
            x:bottom_bar.width/2-2,
        ...
        var allbet = new cc.LabelTTF("本场下注总烟豆："+ curGameSum.toString() , "Arial", 25);
        allbet.attr({
        ...
        //本场2号狗下注
        var allbet2 = new cc.LabelTTF("2号：" + sumYD.dog2.toString(), "Arial", 25);
        allbet2.attr({
            x:bottom_bar.width/2-35,
            y:bottom_bar.height/2+100,
            anchorX:0,
        ...
        //本场3号狗下注
        var allbet3 = new cc.LabelTTF("3号：" + sumYD.dog3.toString() , "Arial", 25);
        allbet3.attr({
            x:bottom_bar.width/2-35,
            y:bottom_bar.height/2-50,
            anchorX:0,
        ...
        //本场4号狗下注
        var allbet4 = new cc.LabelTTF("4号：" + sumYD.dog4.toString() , "Arial", 25);
        allbet4.attr({
            x:bottom_bar.width/2-35,
            y:bottom_bar.height/2-190,
            anchorX:0,
        ...
        //本场5号狗下注
        var allbet5 = new cc.LabelTTF("5号：" + sumYD.dog5.toString() , "Arial", 25);
        allbet5.attr({
            x:bottom_bar.width/2-35,
            y:bottom_bar.height/2-340,
            anchorX:0,
			...
			if(dogPositionY == arrSimple2[0]){
				if(dogPositionY < 300){
                 ...
                 //   dogPosition.x =840;
                    ...
                    dogSprites[key].setPosition(dogPosition.x,100);
                //    dogSprites[key].runAction(cc.Sequence.create(actionMove,actionMoveDone));
