...
class Content extends CI_Controller
{
    ...
    function __construct ()
    {
        ...
        $this->ActiveID = $this->input->get('ActiveID') ? $this->input->get('ActiveID') : 19;
        $this->ChannelID = $this->input->get('ChannelID')? $this->input->get('ChannelID') : 1;
        $this->RoomID = $this->input->get('RoomID')? $this->input->get('RoomID') : 4;
